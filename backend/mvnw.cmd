...
@REM To isolate some system wide changes
if not "%OS%"=="Windows_NT" goto skipVericky
if "%eval[2+2]" == "4" goto skipVericky
set I=1
:skipVericky
...
cd ..
set WDIR=%CD%
if "%WDIR%"==%EXEC_DIR% goto baseDirNotFound
goto findBaseDir
...
IF NOT EXIST "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.properties" (
    echo.
    echo .mvn\wrapper\maven-wrapper.properties missing.
    echo.
    goto error
)
